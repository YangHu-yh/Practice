...
1. Need to know more about stack generally - checked
2. Need to know more about Hash Table generally
3. stack.isEmpty() - checked
4. stack.pop() - checked
5. stack.push() - checked
...
10. Stack<Character> stack = new Stack<Character>();  vs  char[] stack = new char[s.length()]; - checked
